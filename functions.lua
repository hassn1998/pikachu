...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(pikachu..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(pikachu..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(pikachu..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(pikachu..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(pikachu..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(pikachu..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(pikachu..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(pikachu..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(pikachu..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(pikachu..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(pikachu..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(pikachu..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(pikachu..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(pikachu..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(pikachu..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(pikachu..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`👨‍✈️┇مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(pikachu..'username:'..v)
local count = redis:scard(pikachu..'mtwr_count'..v)
...
local monsha = redis:smembers(pikachu..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n\n📋¦ قائمه المدراء :*\n\n'
local list = redis:smembers(pikachu..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(pikachu..'admins:'..msg.chat_id_)
...
local list = redis:smembers(pikachu..'whitelist:'..msg.chat_id_)
...
if redis:sismember(pikachu..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(pikachu..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(pikachu..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(pikachu..'banned:'..msg.chat_id_)
...
if redis:sismember(pikachu..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(pikachu..'gban_users')
...
local list = redis:smembers(pikachu..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(pikachu..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*┇*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(pikachu..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(pikachu..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(pikachu..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(pikachu..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(pikachu..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(pikachu..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(pikachu..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..pikachu..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(pikachu..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(pikachu..'group:name'..GroupS) or '')
...
local admins = redis:smembers(pikachu..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(pikachu..'username:'..value)
if info then 
...
local creator = redis:smembers(pikachu..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(pikachu..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(pikachu..'group:ids')
message = '📋*┇*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(pikachu..'group:name'..v)
if info then 
...
redis:del(
pikachu..'group:add'..id_group,
pikachu..'lock_link'..id_group, 
pikachu..'lock_id'..id_group,
pikachu..'lock_spam'..id_group, 
pikachu..'lock_webpage'..id_group,
pikachu..'lock_markdown'..id_group,
pikachu..'lock_flood'..id_group,
pikachu..'lock_bots'..id_group,
pikachu..'mute_forward'..id_group,
pikachu..'mute_contact'..id_group,
pikachu..'mute_location'..id_group,
pikachu..'mute_document'..id_group,
pikachu..'mute_keyboard'..id_group,
pikachu..'mute_game'..id_group,
pikachu..'mute_inline'..id_group,
pikachu..'lock_username'..id_group,
pikachu..'num_msg_pikachu'..id_group,
pikachu..'replay'..id_group
)
redis:srem(pikachu..'group:ids',id_group)
end
...
redis:hset(pikachu..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(pikachu..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(pikachu..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(pikachu..'group:add'..msg.chat_id_) then  return '🎗*┊*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(pikachu..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(pikachu..':addnumberusers') or 0)
...
local lock_service = redis:get(pikachu..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(pikachu..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(pikachu..':MONSHA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
pikachu..'group:add'..msg.chat_id_,true,
pikachu..'lock_link'..msg.chat_id_,true, 
pikachu..'lock_id'..msg.chat_id_,true,
pikachu..'lock_spam'..msg.chat_id_,true,
pikachu..'lock_webpage'..msg.chat_id_,true,
pikachu..'lock_markdown'..msg.chat_id_,true,
pikachu..'lock_flood'..msg.chat_id_,true,
pikachu..'lock_bots'..msg.chat_id_,true,
pikachu..'mute_forward'..msg.chat_id_,true,
pikachu..'mute_contact'..msg.chat_id_,true,
pikachu..'mute_location'..msg.chat_id_,true,
pikachu..'mute_document'..msg.chat_id_,true,
pikachu..'mute_keyboard'..msg.chat_id_,true,
pikachu..'mute_game'..msg.chat_id_,true,
pikachu..'mute_inline'..msg.chat_id_,true,
pikachu..'lock_username'..msg.chat_id_,true,
pikachu..'num_msg_pikachu'..msg.chat_id_,5, 
pikachu..'replay'..msg.chat_id_,true
)

redis:sadd(pikachu..'group:ids',msg.chat_id_) 
redis:sadd(pikachu..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(pikachu..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(pikachu..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(pikachu..'group:add'..msg.chat_id_) then return '🛠*┊* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(pikachu..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID,'username',Resolv)
redis:sadd(pikachu..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(pikachu..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(pikachu..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(pikachu..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(pikachu..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(pikachu..'whitelist:'..ChatID,UserID)
...
if redis:sismember(pikachu..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..'owners:'..ChatID,UserID)
...
if redis:sismember(pikachu..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(pikachu..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(pikachu..'owners:'..ChatID,UserID)
return SendMntion(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(pikachu..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(pikachu..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(pikachu..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(pikachu..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(pikachu..'banned:'..ChatID,UserID)
...
if redis:sismember(pikachu..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(pikachu..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(pikachu..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(pikachu..'username:'..UserID, 'username',Resolv)
redis:sadd(pikachu..'gban_users',UserID)
...
redis:srem(pikachu..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(pikachu..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(pikachu..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(pikachu..':SUDO_BOT:',UserID)
...
redis:hset(pikachu..'username:'..UserID, 'username', UserName)
redis:sadd(pikachu..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎟*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(pikachu..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎫*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(pikachu..'username:'..UserID, 'username', Resolv)
redis:sadd(pikachu..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(pikachu..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(pikachu..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(pikachu..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » '..USERNAME..' \n🎫*┇* الايدي » (`'..UserID..'`)\n💯*┇*انه بالتأكيد ليس مطور \n✓') end
redis:srem(pikachu..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(pikachu..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(pikachu..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(pikachu..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(pikachu..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾¦*` اعدادات المجموعه :` \n"
.."\n📝┇التعديل ⇜ "..(redis:get(pikachu..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗┇الروابط ⇜ "..(redis:get(pikachu..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣┇التاك ⇜ "..(redis:get(pikachu..'lock_tag'..msg.chat_id_) or 'false')
.."\n©┇المعرفات ⇜ "..(redis:get(pikachu..'lock_username'..msg.chat_id_) or 'false')
.."\n💱┇التكرار ⇜ "..(redis:get(pikachu..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑┇الكلايش ⇜ "..(redis:get(pikachu..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐┇الويب ⇜ "..(redis:get(pikachu..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️┇الماركدوان ⇜ "..(redis:get(pikachu..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻┇البوتات بالطرد ⇜ "..(redis:get(pikachu..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖┇البوتات ⇜ "..(redis:get(pikachu..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕┇عدد التكرار ⇜ "..(redis:get(pikachu..'num_msg_pikachu'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬┇`اعدادات الوسائط :`\n"
.."\n*🎑┇*المتحركه ⇜ "..(redis:get(pikachu..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭┇الدردشه ⇜ "..(redis:get(pikachu..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️┇الانلاين ⇜ "..(redis:get(pikachu..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮┇الالعاب ⇜ "..(redis:get(pikachu..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞┇الصور ⇜ "..(redis:get(pikachu..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥┇الفيديو ⇜ "..(redis:get(pikachu..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙┇البصمات ⇜ "..(redis:get(pikachu..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉┇الصوت ⇜ "..(redis:get(pikachu..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎┇الملصقات ⇜ "..(redis:get(pikachu..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞┇الجهات ⇜ "..(redis:get(pikachu..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱┇التوجيه ⇜ "..(redis:get(pikachu..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐┇الموقع ⇜ "..(redis:get(pikachu..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂┇الملفات ⇜ "..(redis:get(pikachu..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅┇الاشعارات ⇜ "..(redis:get(pikachu..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒┇الكيبورد ⇜ "..(redis:get(pikachu..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒┇*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️┇*الترحيب ⇜ "..welcomex
.."\n*💬┇*الردود ⇜ "..replayx
...
.."\n*➕┇*عدد التكرار ⇜ "..(redis:get(pikachu..'num_msg_pikachu'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*💱┇*`اعدادات التقـييد :`\n"
.."\n*💢┇*التقييد بالتوجيه ⇜ "..(redis:get(pikachu..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸┇*التقييد بالصور ⇜ "..(redis:get(pikachu..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗┇*التقييد بالروابط ⇜ "..(redis:get(pikachu..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉┇*التقييد بالمتحركه ⇜ "..(redis:get(pikachu..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥┇*التقييد الفيديو ⇜ "..(redis:get(pikachu..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❪ مقفول ❫')
list_settings = list_settings:gsub('false', '❪ مفتوح ❫')
