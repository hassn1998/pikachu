...
if MsgText[2] == '3' then
redis:set(pikachu..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(pikachu..'CheckExpire::'..msg.chat_id_) then 
redis:set(pikachu..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(pikachu..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(pikachu..'group:name'..msg.chat_id_) or '')
...
redis:del(pikachu..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(pikachu..'owners:'..msg.chat_id_)
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(pikachu..'ExCmdLink'..msg.chat_id_) then
...
local Text = "🔖┇رابـط الـمـجـمـوعه 💯\n🌿┇"..Flter_Markdown(redis:get(pikachu..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
return "*🔖┇القوانين :*\n"..redis:get(pikachu..'rulse:msg'..msg.chat_id_) 
end 
end
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(pikachu..'welcome:msg'..msg.chat_id_) then 
...
redis:del(pikachu..':MONSHA_BOT:'..msg.chat_id_)
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(pikachu..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(pikachu..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(pikachu..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(pikachu..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local msgs = redis:get(pikachu..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
redis:del(pikachu..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♦️*┇*تم مسح {* "..msgs.." *} من رسائلك ☔️\n✓"
end

if MsgText[1]== 'جهاتي' then
return '🧟‍♂*┇*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(pikachu..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(pikachu..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*┇*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(pikachu..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:set(pikachu..'welcom:witting'..msg.sender_user_id_,true) 
...
return Flter_Markdown(redis:get(pikachu..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."  \n🌿┇نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
redis:setex(pikachu..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(pikachu..':WELCOME_BOT')
...
redis:set(pikachu..':addnumberusers',MsgText[2]) 
return '💱*┇* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*┇* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(pikachu..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
return '📮*┇* عدد المجموعات المفعلة » `'..redis:scard(pikachu..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين 💥" then
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*┊*عدد المشتركين في البوت : `'..redis:scard(pikachu..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*┇*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(pikachu..'group:ids',MsgText[2]) then
local name_gp = redis:get(pikachu..'group:name'..MsgText[2])
...
return redis:get(pikachu..":TEXT_SUDO") or '🗃┇لا توجد كليشه المطور .\n📰┇يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end
...
redis:setex(pikachu..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:set(pikachu..":VERSION",GetVerison)
return false
else
return "🔖┊سـورس بيكاجو\n👨🏾‍🔧*┊* لديـك احدث اصدار \n📦"
end
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
return '🎭┊الاحصائيات 🏌‍♂ \n\n👥*┊*عدد المجموعات المفعله : '..redis:scard(pikachu..'group:ids')..'\n🙍🏻‍♂*┊*عدد المشتركين في البوت : '..redis:scard(pikachu..'users')..'\n📡'
end
---------------[End Function data] -----------------------
...
redis:del(pikachu..'replay:'..msg.chat_id_,pikachu..'replay_photo:group:'..msg.chat_id_,pikachu..'replay_voice:group:'..msg.chat_id_,
pikachu..'replay_animation:group:'..msg.chat_id_,pikachu..'replay_audio:group:'..msg.chat_id_,pikachu..'replay_sticker:group:'..msg.chat_id_,pikachu..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(pikachu..'replay:all')
local photo 	= redis:exists(pikachu..'replay_photo:group:')
local voice 	= redis:exists(pikachu..'replay_voice:group:')
local imation 	= redis:exists(pikachu..'replay_animation:group:')
local audio 	= redis:exists(pikachu..'replay_audio:group:')
local sticker 	= redis:exists(pikachu..'replay_sticker:group:')
local video 	= redis:exists(pikachu..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(pikachu..'replay:all',pikachu..'replay_photo:group:',pikachu..'replay_voice:group:',pikachu..'replay_animation:group:',pikachu..'replay_audio:group:',pikachu..'replay_sticker:group:',pikachu..'replay_video:group:')
...
if not msg.Director then return "♦️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:set(pikachu..'delrd:'..msg.sender_user_id_,true)
...
local names 	= redis:hkeys(pikachu..'replay:all')
local photo 	= redis:hkeys(pikachu..'replay_photo:group:')
local voice 	= redis:hkeys(pikachu..'replay_voice:group:')
local imation 	= redis:hkeys(pikachu..'replay_animation:group:')
local audio 	= redis:hkeys(pikachu..'replay_audio:group:')
local sticker 	= redis:hkeys(pikachu..'replay_sticker:group:')
local video 	= redis:hkeys(pikachu..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*┊*لا يوجد ردود مضافه حاليا \n💥' 
end
local ii = 1
...
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(pikachu..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(pikachu..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*┇*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(pikachu..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*┇*أهلا عزيزي "..msg.TheRankCmd.."\n📡*┇* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(pikachu..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
if redis:get(pikachu..":UserNameChaneel") then
...
if not msg.SudoBase then return"♦️*┇*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local SubDel = redis:del(pikachu..":UserNameChaneel")
if SubDel == 1 then
...
local function dpikachu(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(pikachu..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(pikachu..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛┇* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(pikachu..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(pikachu..'users',msg.sender_user_id_)
if redis:get(pikachu..'lock_service') then 
text = [[⚜┊اهلا انآ بوت آسـمـي   []]..redis:get(pikachu..':NameBot:')..[[] 🎖
👨🏻‍✈️┊آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛┊مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
local MSG_ID = (redis:get(pikachu.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
redis:setex(pikachu.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
local klma = redis:get(pikachu..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
...
if redis:get(pikachu..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(pikachu..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(pikachu..'users')  
local groups = redis:smembers(pikachu..'group:ids')
...
if redis:get(pikachu..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(pikachu..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(pikachu..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(pikachu..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
local NUM_MSG_pikachu = (redis:get(pikachu..'num_msg_pikachu'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_pikachu) then 
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(pikachu..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(pikachu..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(pikachu..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(pikachu..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(pikachu..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(pikachu..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(pikachu..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(pikachu..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(pikachu..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(pikachu..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(pikachu..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(pikachu..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
local ExpireDate = redis:ttl(pikachu..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️┇انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧┇المجموعه : '..FlterName(redis:get(pikachu..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️┇ايدي : '..msg.chat_id_)
