...
redis:set("TH3pikachu_INSTALL","Yes")
info = {}
...
msg.Rank = 1
elseif redis:sismember(pikachu..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور 👨🏽‍💻'
msg.TheRank = 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(pikachu..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء 👷🏽'
msg.TheRank = 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(pikachu..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير 👨🏼‍⚕️' 
msg.TheRank = 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(pikachu..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن 👨🏼‍🎓'
msg.TheRank = 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(pikachu..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
if msg.Admin then redis:srem(pikachu..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(pikachu..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
for k, pikachu in pairs(ScriptFile.pikachu) do
local SearchText = msg.text:match(pikachu)
if SearchText then
if not CheckFlood(msg) then
return false 
end
local GetMsg = ScriptFile.ipikachu(msg,{msg.text:match(pikachu)})
if GetMsg then
...
if ScriptFile.dpikachu then
if ScriptFile.dpikachu(msg) == false then
return false
end
...
if msg.text and Plug.ipikachu then
...
local GetMsg = Plug.ipikachu(msg,{msg.text:match(pikachu)})
if GetMsg then
...
if Plug.dpikachu then
Plug.dpikachu(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source pikachu")
end 

end
else
print("The File Script.lua Not Runing in The Source pikachu")
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/pikachuTELE/pikachu/master/plugins/games.lua','./plugins/games.lua')
	...
	if redis:get(pikachu..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(pikachu..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(pikachu..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(pikachu..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(pikachu..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(pikachu..'lock_bots'..msg.chat_id_)
	ISBOT = false
	ZISBOT = false
	...
	if ZISBOT and redis:get(pikachu..'lock_bots_by_kick'..msg.chat_id_) then
	...
	if redis:get(pikachu..'group:add'..data.chat_.id_) then
	redis:set(pikachu..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(pikachu..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(pikachu..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(pikachu..'group:name-100'..data.channel_.id_) or "")
	...
	redis:sadd(pikachu..'group:ids',k) 
	...
	redis:hset(pikachu..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
