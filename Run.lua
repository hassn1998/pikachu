...
function tdcli_update_callback(data)
	...
	download_file('https://github.com/hassn1998/pikachu/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://github.com/hassn1998/pikachu/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://github.com/hassn1998/pikachu/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://github.com/hassn1998/pikachu/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://github.com/hassn1998/pikachu/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://github.com/hassn1998/pikachu/master/plugins/games.lua','./plugins/games.lua')
