...
if not redis:get(pikachu..'lock_geams'..msg.chat_id_) then 
return "*🙋🏻‍♂┊ مرحباً عزيزي "..msg.TheRankCmd.."\n✔┊ الالعاب بالتأكيد مفعله\n*" 
else 
redis:del(pikachu..'lock_geams'..msg.chat_id_) 
return "*🙋🏻‍♂┊ مرحباً عزيزي "..msg.TheRankCmd.."\n✔┊ تم تفعيل الالعاب\n*" 
end 
end
...
if redis:get(pikachu..'lock_geams'..msg.chat_id_) then 
return "*🙋🏼‍♂️┊ مرحباً عزيزي "..msg.TheRankCmd.." \n📡┊ الالعاب بالتأكيد معطله \n*" 
else
redis:set(pikachu..'lock_geams'..msg.chat_id_,true)  
return "*🙋🏼‍♂️┊ مرحباً عزيزي "..msg.TheRankCmd.." \n📡┊ تم تعطيل الالعاب \n*" 
end   
end
...
redis:set(pikachu..'SET:ID:USER'..msg.chat_id_,ID_USER)  
redis:setex(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*📊┊ ارسل لي عدد الرسائل الذي تريده*')
end
if MsgText[1] == "اضف مجوهرات" and msg.reply_to_message_id_ == 0 then       
if not msg.Creator then return "📛*┊* هذا الامر يخص {المطور,المنشئ} فقط  \n🚶" end
local ID_USER = MsgText[2]
redis:set(pikachu..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
redis:setex(pikachu.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*📊┊ ارسل لي عدد المجوهرات الذي تريده*')
end
if not redis:get(pikachu..'lock_geams'..msg.chat_id_) and msg.GroupActive then


if MsgText[1] == 'محيبس' or MsgText[1] == 'بات' then   
Num = math.random(1,6)
redis:set(pikachu.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*🙋🏻‍♂┊ اهلن عزيزي 
...
redis:setex(pikachu.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
redis:set(pikachu..':Set_Aks:'..msg.chat_id_,name)
...
redis:set(pikachu..':NUM_SET:'..msg.chat_id_,(NUM * 3))
...
redis:set(pikachu..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(pikachu..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(pikachu..':NUM_SET:'..msg.chat_id_)) then
return '👁‍🗨┇اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(pikachu..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️👁‍🗨┇اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(pikachu..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
name = hasone[math.random(#hasone)]
redis:set(pikachu..':Set_Arg:'..msg.chat_id_,name)
...
name = hasone[math.random(#hasone)]
redis:set(pikachu..':Set_Name_Meant:'..msg.chat_id_,name)
...
redis:decrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,MsgText[2])  
redis:incrby(pikachu..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "💰┊ تم خصم {* "..MsgText[2].." *} من مجوهراتك\n📮| تم زياده {* "..Total_Point.."* } من الرسائل \n📑| اصبحت رسائلك { *"..redis:get(pikachu..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n🔖"
end
end
...
redis:del(pikachu..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:del(pikachu..':List_Rolet:'..msg.chat_id_)  
redis:setex(pikachu..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_,3600,true)  
return '*🎪┊ حسننا لنلعب ,ارسل عدد الاعبين للروليت\n*'
end
if MsgText[1] == 'نعم' and redis:get(pikachu..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_) then
local list = redis:smembers(pikachu..':List_Rolet:'..msg.chat_id_) 
if #list == 1 then 
...
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..data.id_,2)
end,nil)
redis:del(pikachu..':List_Rolet:'..msg.chat_id_) 
redis:del(pikachu..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.text and not redis:get(pikachu..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(pikachu..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(pikachu..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎊┊ احسنت اجابتك صحيحه*')end

if msg.text == redis:get(pikachu..':Set_Aks:'..msg.chat_id_) then -- // عكس
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(pikachu..':Set_Aks:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎊┊ احسنت اجابتك صحيحه*')end

if msg.text == redis:get(pikachu..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(pikachu..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎊┊ احسنت اجابتك صحيحه*')end
if msg.text == redis:get(pikachu..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(pikachu..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎊┊ احسنت اجابتك صحيحه*')end
if redis:get(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
redis:del(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(pikachu..'SET:ID:USER'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*┊ روح خالي 😉 تم اضافة له { "..msg.text.." }* رساله")
redis:incrby(pikachu..'msgs:'..GET_IDUSER..':'..msg.chat_id_,msg.text)  
end
redis:del(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end

if redis:get(pikachu.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999 then
sendMsg(msg.chat_id_,msg.id_,"*📬┊ لا تستطيع اضافة اكثر من 99999999 نقطه\n*")   
redis:del(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(pikachu..'SET:ID:USER:NUM'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*┊ طكو طكو عمي 😻 تم اضافة له { "..msg.text.." }* مجوهره")
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..GET_IDUSER,msg.text)  
end
redis:del(pikachu.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end


if msg.text:match("^(%d+)$") and redis:get(pikachu..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
Text = "*📮┊* لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
redis:set(pikachu..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '\n💬┊ تم بدء تسجيل السته\n💱┊ يرجى ارسال المعرفات \n🎊┊ الفائز يحصل على 2 مجوهرات\n🎯┊ عدد الاعبين المطلوب ❪ *'..msg.text..'* ❫\n'
end
redis:del(pikachu..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(pikachu..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(pikachu..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*📮┊* المعرف {['..msg.text..']} موجود اساسا' )
end
redis:sadd(pikachu..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(pikachu..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(pikachu..':List_Rolet:'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
redis:del(pikachu..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:setex(pikachu..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_,1400,true)  
...
if redis:get(pikachu.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
sendMsg(msg.chat_id_,msg.id_,"*📬┊ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n")   
return false  end 
local GETNUM = redis:get(pikachu.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(pikachu.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'*✔┊ العب وخوش تلعب \n✔┊ حصلت على 3 مجوهرات \n*')   
redis:incrby(pikachu..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
...
if redis:get(pikachu.."chencher"..msg.sender_user_id_) then 
if redis:get(pikachu.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
hasan = '['..(redis:get(pikachu.."chencher"..msg.sender_user_id_) or '')..']'
...
redis:set(pikachu.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
